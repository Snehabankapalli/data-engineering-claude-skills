...
echo "  /tf-infra           — Terraform for AWS data infra"
echo "  /data-quality       — data quality audit + health score"
echo "  /debug-pipeline     — structured pipeline debugging"
echo "  /mcp-server         — build a FastMCP server"
echo ""
